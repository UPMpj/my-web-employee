...
<div class="card">
  ...
  <div class="data-panel">
    ...
    <div class="info-rows">
      ...
      ${r(f,"COMPANY",(t.companies_name||"–").substring(0,18))}
      ${r(p,"NATIONALITY",t.nationality||"–")}
      ${r(g,"DOCUMENT ID.",i?t.card_no:"Not Issued")}
      ${r(v,"LOCATION",T(t).substring(0,18))}
    </div>
  </div>
...
</body></html>`,o=window.open("","_blank","width=900,height=700");o&&(o.document.write(i),o.document.close())}export{T as f,C as g,S as p};
