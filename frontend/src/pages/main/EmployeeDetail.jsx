        ...
        <form className="ed-doc-form" onSubmit={submit}>
          ...
          <div className="ed-form-row">
            ...
            <div className="ed-form-group">
              ...
              <button type="button" className="ed-file-btn" onClick={() => fileRef.current.click()}>
            ...
            {previewUrl && (
              <div style={{display:"flex",alignItems:"center",gap:8}}>
                <img src={previewUrl} alt="preview"
                  style={{height:60,borderRadius:6,border:"1px solid #e5e7eb",objectFit:"cover",cursor:"zoom-in"}}
                  onClick={() => setLightbox(previewUrl)} />
                <button type="button" style={{fontSize:11,color:"#ef4444",background:"none",border:"none",cursor:"pointer"}}
                  onClick={resetFile}>✕ ລຶບ</button>
              </div>
            )}
          </div>
                    ...
                    {imgUrl
                      ...
                      : fileUrl
                        ? <a href={fileUrl} target="_blank" rel="noreferrer"
                            style={{display:"flex",alignItems:"center",justifyContent:"center",width:48,height:48,borderRadius:6,border:"1px solid #e5e7eb",background:"#f9fafb",textDecoration:"none",fontSize:11,color:"#6366f1",fontWeight:600}}>
                            PDF
                          </a>
