...
const TEMPLATES = {
  Staff:      { key:"Staff",      img:"/id-card/IT_STAFF1.png?v=10",    panelBg:"#0c1a30", footBg:"#07101e", photoBorder:"#80bbf5" },
  Supervisor: { key:"Supervisor", img:"/id-card/supervisor1.png?v=10",  panelBg:"#091e19", footBg:"#05120d", photoBorder:"#55c8be" },
  Manager:    { key:"Manager",    img:"/id-card/manager1.png?v=10",     panelBg:"#110826", footBg:"#090518", photoBorder:"#b775fb" },
};
